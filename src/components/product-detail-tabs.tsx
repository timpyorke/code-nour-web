      ...
      {activeTab === 'screenshot' && (
        <div className="relative group">
          {product.screenshots && product.screenshots.length > 0 ? (
            <>
              <div className="flex items-center justify-end mb-4 text-gray-400 text-xs gap-1.5 font-medium tracking-wide uppercase">
              ...
              {product.screenshots.map((src, i) => (
                <div
                  key={i}
                  className="flex-none w-[280px] rounded-2xl overflow-hidden bg-gray-100 aspect-[9/16] snap-center border border-gray-100 shadow-sm"
                >
